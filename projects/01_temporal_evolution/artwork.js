...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function ph(){return new be({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:bc(),fragmentShader:`
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function mh(){return new be({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bc(),fragmentShader:`
	...
	`}function am(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){let c=o.mapping,l=c===ra||c===aa,h=c===bi||c===Si;if(l||h){let u=t.get(o),d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return e===null&&(e=new Ga(i)),u=l?e.fromEquirectangular(o,u):e.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),u.texture;if(u!==void 0)return u.texture;{let p=o.image;return l&&p&&p.height>0||h&&p&&s(p)?(e===null&&(e=new Ga(i)),u=l?e.fromEquirectangular(o):e.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let c=0,l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){let c=o.target;c.removeEventListener("dispose",r);let l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function om(i){let t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){let s=e(n);return s===null&&_i("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function cm(i,t,e,n){let s={},r=new WeakMap;function a(u){let d=u.target;d.index!==null&&t.remove(d.index);for(let g in d.attributes)t.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete s[d.id];let p=r.get(d);p&&(t.remove(p),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,e.memory.geometries++),d}function c(u){let d=u.attributes;for(let p in d)t.update(d[p],i.ARRAY_BUFFER)}function l(u){let d=[],p=u.index,g=u.attributes.position,_=0;if(p!==null){let E=p.array;_=p.version;for(let S=0,M=E.length;S<M;S+=3){let I=E[S+0],A=E[S+1],R=E[S+2];d.push(I,A,A,R,R,I)}}else if(g!==void 0){let E=g.array;_=g.version;for(let S=0,M=E.length/3-1;S<M;S+=3){let I=S+0,A=S+1,R=S+2;d.push(I,A,A,R,R,I)}}else return;let m=new(nc(d)?As:ws)(d,1);m.version=_;let f=r.get(u);f&&t.remove(f),r.set(u,m)}function h(u){let d=r.get(u);if(d){let p=u.index;p!==null&&d.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function lm(i,t,e){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function c(d,p){i.drawElements(n,p,r,d*a),e.update(p,n,1)}function l(d,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,d*a,g),e.update(p,n,g))}function h(d,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];e.update(m,n,1)}function u(d,p,g,_){if(g===0)return;let m=t.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)l(d[f]/a,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,d,0,_,0,g);let f=0;for(let E=0;E<g;E++)f+=p[E]*_[E];e.update(f,n,1)}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function hm(i){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(r/3);break;case i.LINES:e.lines+=o*(r/2);break;case i.LINE_STRIP:e.lines+=o*(r-1);break;case i.LINE_LOOP:e.lines+=o*r;break;case i.POINTS:e.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function um(i,t,e){let n=new WeakMap,s=new fe;function r(a,o,c){let l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0,d=n.get(o);if(d===void 0||d.count!==u){let b=function(){R.dispose(),n.delete(o),o.removeEventListener("dispose",b)};d!==void 0&&d.texture.dispose();let p=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,_=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],f=o.morphAttributes.normal||[],E=o.morphAttributes.color||[],S=0;p===!0&&(S=1),g===!0&&(S=2),_===!0&&(S=3);let M=o.attributes.position.count*S,I=1;M>t.maxTextureSize&&(I=Math.ceil(M/t.maxTextureSize),M=t.maxTextureSize);let A=new Float32Array(M*I*4*u),R=new Ts(A,M,I,u);R.type=Sn,R.needsUpdate=!0;let N=S*4;for(let y=0;y<u;y++){let P=m[y],V=f[y],z=E[y],X=M*I*4*y;for(let K=0;K<P.count;K++){let G=K*N;p===!0&&(s.fromBufferAttribute(P,K),A[X+G+0]=s.x,A[X+G+1]=s.y,A[X+G+2]=s.z,A[X+G+3]=0),g===!0&&(s.fromBufferAttribute(V,K),A[X+G+4]=s.x,A[X+G+5]=s.y,A[X+G+6]=s.z,A[X+G+7]=0),_===!0&&(s.fromBufferAttribute(z,K),A[X+G+8]=s.x,A[X+G+9]=s.y,A[X+G+10]=s.z,A[X+G+11]=z.itemSize===4?s.w:1)}}d={count:u,texture:R,size:new qt(M,I)},n.set(o,d),o.addEventListener("dispose",b)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let p=0;for(let _=0;_<l.length;_++)p+=l[_];let g=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function dm(i,t,e,n){let s=new WeakMap;function r(c){let l=n.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){let d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function a(){s=new WeakMap}function o(c){let l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:a}}var Uh=new We,gh=new Ls(1,1),Nh=new Ts,Fh=new Ur,Oh=new Cs,_h=[],xh=[],vh=new Float32Array(16),yh=new Float32Array(9),Mh=new Float32Array(4);function ls(i,t,e){let n=i[0];if(n<=0||n>0)return i;let s=t*e,r=_h[s];if(r===void 0&&(r=new Float32Array(s),_h[s]=r),t!==0){n.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(r,o)}return r}function xe(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function ve(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Xa(i,t){let e=xh[t];e===void 0&&(e=new Int32Array(t),xh[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function fm(i,t){let e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function pm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;i.uniform2fv(this.addr,t),ve(e,t)}}function mm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(xe(e,t))return;i.uniform3fv(this.addr,t),ve(e,t)}}function gm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;i.uniform4fv(this.addr,t),ve(e,t)}}function _m(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),ve(e,t)}else{if(xe(e,n))return;Mh.set(n),i.uniformMatrix2fv(this.addr,!1,Mh),ve(e,n)}}function xm(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),ve(e,t)}else{if(xe(e,n))return;yh.set(n),i.uniformMatrix3fv(this.addr,!1,yh),ve(e,n)}}function vm(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(xe(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),ve(e,t)}else{if(xe(e,n))return;vh.set(n),i.uniformMatrix4fv(this.addr,!1,vh),ve(e,n)}}function ym(i,t){let e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Mm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;i.uniform2iv(this.addr,t),ve(e,t)}}function bm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(xe(e,t))return;i.uniform3iv(this.addr,t),ve(e,t)}}function Sm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;i.uniform4iv(this.addr,t),ve(e,t)}}function Em(i,t){let e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Tm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(xe(e,t))return;i.uniform2uiv(this.addr,t),ve(e,t)}}function wm(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(xe(e,t))return;i.uniform3uiv(this.addr,t),ve(e,t)}}function Am(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(xe(e,t))return;i.uniform4uiv(this.addr,t),ve(e,t)}}function Rm(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(gh.compareFunction=Qo,r=gh):r=Uh,e.setTexture2D(t||r,s)}function Cm(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Fh,s)}function Im(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Oh,s)}function Pm(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Nh,s)}function Lm(i){switch(i){case 5126:return fm;case 35664:return pm;case 35665:return mm;case 35666:return gm;case 35674:return _m;case 35675:return xm;case 35676:return vm;case 5124:case 35670:return ym;case 35667:case 35671:return Mm;case 35668:case 35672:return bm;case 35669:case 35673:return Sm;case 5125:return Em;case 36294:return Tm;case 36295:return wm;case 36296:return Am;case 35678:case 36198:case 36298:case 36306:case 35682:return Rm;case 35679:case 36299:case 36307:return Cm;case 35680:case 36300:case 36308:case 36293:return Im;case 36289:case 36303:case 36311:case 36292:return Pm}}function Dm(i,t){i.uniform1fv(this.addr,t)}function Um(i,t){let e=ls(t,this.size,2);i.uniform2fv(this.addr,e)}function Nm(i,t){let e=ls(t,this.size,3);i.uniform3fv(this.addr,e)}function Fm(i,t){let e=ls(t,this.size,4);i.uniform4fv(this.addr,e)}function Om(i,t){let e=ls(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Bm(i,t){let e=ls(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function zm(i,t){let e=ls(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Hm(i,t){i.uniform1iv(this.addr,t)}function km(i,t){i.uniform2iv(this.addr,t)}function Vm(i,t){i.uniform3iv(this.addr,t)}function Gm(i,t){i.uniform4iv(this.addr,t)}function Wm(i,t){i.uniform1uiv(this.addr,t)}function Xm(i,t){i.uniform2uiv(this.addr,t)}function qm(i,t){i.uniform3uiv(this.addr,t)}function Ym(i,t){i.uniform4uiv(this.addr,t)}function $m(i,t,e){let n=this.cache,s=t.length,r=Xa(e,s);xe(n,r)||(i.uniform1iv(this.addr,r),ve(n,r));for(let a=0;a!==s;++a)e.setTexture2D(t[a]||Uh,r[a])}function Zm(i,t,e){let n=this.cache,s=t.length,r=Xa(e,s);xe(n,r)||(i.uniform1iv(this.addr,r),ve(n,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||Fh,r[a])}function Jm(i,t,e){let n=this.cache,s=t.length,r=Xa(e,s);xe(n,r)||(i.uniform1iv(this.addr,r),ve(n,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||Oh,r[a])}function Km(i,t,e){let n=this.cache,s=t.length,r=Xa(e,s);xe(n,r)||(i.uniform1iv(this.addr,r),ve(n,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||Nh,r[a])}function jm(i){switch(i){case 5126:return Dm;case 35664:return Um;case 35665:return Nm;case 35666:return Fm;case 35674:return Om;case 35675:return Bm;case 35676:return zm;case 5124:case 35670:return Hm;case 35667:case 35671:return km;case 35668:case 35672:return Vm;case 35669:case 35673:return Gm;case 5125:return Wm;case 36294:return Xm;case 36295:return qm;case 36296:return Ym;case 35678:case 36198:case 36298:case 36306:case 35682:return $m;case 35679:case 36299:case 36307:return Zm;case 35680:case 36300:case 36308:case 36293:return Jm;case 36289:case 36303:case 36311:case 36292:return Km}}var pc=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Lm(e.type)}},mc=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=jm(e.type)}},gc=class{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(t,e[o.id],n)}}},fc=/(\w+)(\])?(\[|\.)?/g;function bh(i,t){i.seq.push(t),i.map[t.id]=t}function Qm(i,t,e){let n=i.name,s=n.length;for(fc.lastIndex=0;;){let r=fc.exec(n),a=fc.lastIndex,o=r[1],c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){bh(e,l===void 0?new pc(o,i,t):new mc(o,i,t));break}else{let u=e.map[o];u===void 0&&(u=new gc(o),bh(e,u)),e=u}}}var cs=class{constructor(t,e){this.seq=[],this.map={};let n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let r=t.getActiveUniform(e,s),a=t.getUniformLocation(e,r.name);Qm(r,a,this)}}setValue(t,e,n,s){let r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){let s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,a=e.length;r!==a;++r){let o=e[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(t,c.value,s)}}static seqWithValue(t,e){let n=[];for(let s=0,r=t.length;s!==r;++s){let a=t[s];a.id in e&&n.push(a)}return n}};function Sh(i,t,e){let n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}var tg=37297,eg=0;function ng(i,t){let e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}var Eh=new Ut;function ig(i){Gt._getMatrix(Eh,Gt.workingColorSpace,i);let t=`mat3( ${Eh.elements.map(e=>e.toFixed(4))} )`;switch(Gt.getTransfer(i)){case bs:return[t,"LinearTransferOETF"];case Kt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function Th(i,t,e){let n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";let r=/ERROR: 0:(\d+)/.exec(s);if(r){let a=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+ng(i.getShaderSource(t),a)}else return s}function sg(i,t){let e=ig(t);return[`vec4 ${i}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function rg(i,t){let e;switch(t){case Bl:e="Linear";break;case zl:e="Reinhard";break;case Hl:e="Cineon";break;case kl:e="ACESFilmic";break;case Gl:e="AgX";break;case Wl:e="Neutral";break;case Vl:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var Va=new L;function ag(){Gt.getLuminanceCoefficients(Va);let i=Va.x.toFixed(4),t=Va.y.toFixed(4),e=Va.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function og(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Xs).join(`
`)}function cg(i){let t=[];for(let e in i){let n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function lg(i,t){let e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(t,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function Xs(i){return i!==""}function wh(i,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Ah(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var hg=/^[ \t]*#include +<([\w\d./]+)>/gm;function _c(i){return i.replace(hg,dg)}var ug=new Map;function dg(i,t){let e=Ft[t];if(e===void 0){let n=ug.get(t);if(n!==void 0)e=Ft[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return _c(e)}var fg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Rh(i){return i.replace(fg,pg)}function pg(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ch(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function mg(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ho?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===_l?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===yn&&(t="SHADOWMAP_TYPE_VSM"),t}function gg(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case bi:case Si:t="ENVMAP_TYPE_CUBE";break;case Bs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function _g(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Si:t="ENVMAP_MODE_REFRACTION";break}return t}function xg(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Go:t="ENVMAP_BLENDING_MULTIPLY";break;case Fl:t="ENVMAP_BLENDING_MIX";break;case Ol:t="ENVMAP_BLENDING_ADD";break}return t}function vg(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function yg(i,t,e,n){let s=i.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,c=mg(e),l=gg(e),h=_g(e),u=xg(e),d=vg(e),p=og(e),g=cg(r),_=s.createProgram(),m,f,E=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+f);let S=E+m+a,M=E+f+o,I=Sh(s,s.VERTEX_SHADER,S),A=Sh(s,s.FRAGMENT_SHADER,M);s.attachShader(_,I),s.attachShader(_,A),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function R(P){if(i.debug.checkShaderErrors){let V=s.getProgramInfoLog(_).trim(),z=s.getShaderInfoLog(I).trim(),X=s.getShaderInfoLog(A).trim(),K=!0,G=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,I,A);else{let tt=Th(s,I,"vertex"),H=Th(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
`;function t0(i){if(!i.points||!i.pointScale)return[];let t=atob(i.points),e=new Uint8Array(t.length);for(let r=0;r<t.length;r++)e[r]=t.charCodeAt(r);let n=new Int16Array(e.buffer),s=[];for(let r=0;r<n.length;r+=3)s.push(new L(n[r]*i.pointScale,n[r+1]*i.pointScale,n[r+2]*i.pointScale));return s}function e0(i){if(!i.edges)return[];let t=atob(i.edges),e=new Uint8Array(t.length);for(let r=0;r<t.length;r++)e[r]=t.charCodeAt(r);let n=new Uint16Array(e.buffer),s=[];for(let r=0;r<n.length;r+=2)s.push([n[r],n[r+1]]);return s}function n0(){let i=[],t=[];for(let s=0;s<9;s++)for(let r=0;r<110;r++){let a=r/109;i.push(new L(a*2-1,(s/8-.5)*.7+Math.sin(a*Math.PI*5+s*.7)*.045,Math.cos(a*9+s)*.12)),r&&t.push([s*110+r-1,s*110+r])}return{points:i,edges:t}}function i0(){let i=[],t=[],e=19071976,n=()=>(e=e*48271%2147483647,e/2147483647),s=7,r=[];for(let a=0;a<s;a++){let o=a/s*Math.PI*2,c=new L(-1.18+n()*.08,Math.sin(o)*.09,Math.cos(o)*.09);i.push(c),r.push({index:i.length-1,direction:new L(.48+n()*.16,Math.sin(o)*.82,Math.cos(o)*.68).normalize(),generation:0})}for(let a=0;a<92&&i.length<1050;a++){let o=[];r.forEach(c=>{if(i.length>=1050)return;let l=i[c.index],h=new L(.045+n()*.055,(n()-.5)*.145,(n()-.5)*.125),u=c.direction.clone().multiplyScalar(.82).add(h).normalize(),d=.041+n()*.03,p=l.clone().addScaledVector(u,d);p.y+=Math.sin(p.x*7.3+c.generation)*.002;let g=i.push(p)-1;t.push([c.index,g]),o.push({index:g,direction:u,generation:c.generation});let _=a<14?.14:.045+Math.min(.07,c.generation*.008);if(n()<_&&o.length<74&&i.length<1048){let m=new L(n()-.5,n()-.5,n()-.5).normalize(),f=u.clone().applyAxisAngle(m,.34+n()*.58);o.push({index:g,direction:f,generation:c.generation+1})}}),r=o.sort((c,l)=>Me(`${c.index}:hypha`)-Me(`${l.index}:hypha`)).slice(0,66)}for(let a=28;a<i.length;a+=2){let o=-1,c=.14,l=Math.max(0,a-210);for(let h=l;h<a-9;h++){let u=i[a].distanceTo(i[h]);u<c&&(o=h,c=u)}o>=0&&n()<.48&&t.push([a,o])}return{points:i,edges:t}}function eu(i,t){return t==="elegans"?new L(i.y,i.x,i.z):t==="rodent"?new L(i.x,i.z,i.y):t==="macaque"||t==="human"?new L(i.y,i.z,i.x):i.clone()}function s0(i,t,e){let n=i.points.map(l=>eu(l,t)),s=new un().setFromPoints(n),r=s.getSize(new L),a=s.getCenter(new L),o=Math.min(2.62/Math.max(r.x,.01),.64/Math.max(r.y,.01));return{points:n.map(l=>new L(Ze+(l.x-a.x)*o,e+(l.y-a.y)*o,(l.z-a.z)*o*.46)),edges:i.edges}}function Yh(i,t){let e=i.points.map(o=>eu(o,t)),n=new un().setFromPoints(e),s=n.getCenter(new L),r=n.getSize(new L),a=2.45/Math.max(r.x,r.y,r.z,.001);return{points:e.map(o=>o.clone().sub(s).multiplyScalar(a)),edges:i.edges}}function r0(i,t){let e=Array.from({length:i.points.length},()=>[]);i.edges.forEach(([u,d])=>{u<e.length&&d<e.length&&(e[u].push(d),e[d].push(u))});let n=Math.max(1,...e.map(u=>u.length)),s=e.map((u,d)=>({index:d,degree:u.length})).sort((u,d)=>d.degree-u.degree||Me(`${t}:${u.index}`)-Me(`${t}:${d.index}`)).slice(0,Math.max(1,Math.min(5,Math.floor(i.points.length/180)))).map(u=>u.index),r=new Int32Array(i.points.length).fill(-1),a=[...s];s.forEach(u=>{r[u]=0});for(let u=0;u<a.length;u++){let d=a[u];e[d].forEach(p=>{r[p]>=0||(r[p]=r[d]+1,a.push(p))})}let o=Math.max(1,...r),c=new Float32Array(i.points.length),l=new Float32Array(i.points.length),h=new Float32Array(i.points.length);for(let u=0;u<i.points.length;u++){let d=r[u]<0?o*Me(`${t}:${u}:island`):r[u];c[u]=(d/o+Me(`${t}:${u}:phase`)*.11)%1,l[u]=Math.log1p(e[u].length)/Math.log1p(n),h[u]=Me(`${t}:${u}:spark`)}return{phase:c,degree:l,seed:h}}var a0=.36;function Dc(i){return a0}function o0(i,t,e=""){let n=Math.max(0,yt.strips.findIndex(g=>g.id===e)),s=new L(Ze,Wn-n*fn,0),r=new en;r.position.copy(s),r.userData.spinRate=Dc(e);let a=new Float32Array(i.points.length*3);i.points.forEach((g,_)=>g.clone().sub(s).toArray(a,_*3));let o=new ee;o.setAttribute("position",new ae(a,3));let c=ai.clamp(Math.sqrt(280/Math.max(1,i.points.length)),.24,.9),l=e==="ai"?.75:1,h=new Oe(o,new vn({color:t,size:1.1*l,sizeAttenuation:!1,transparent:!0,opacity:.14*c,blending:Ge,depthWrite:!1}));r.add(h);let u=new Oe(o,new vn({color:t,size:2.1*l,sizeAttenuation:!1,transparent:!0,opacity:.005*c,blending:Ye,depthWrite:!1}));r.add(u);let d=new Float32Array(i.edges.length*6);i.edges.forEach(([g,_],m)=>{i.points[g]?.clone().sub(s).toArray(d,m*6),i.points[_]?.clone().sub(s).toArray(d,m*6+3)});let p=new ee;p.setAttribute("position",new ae(d,3)),r.add(new On(p,new Xe({color:t,transparent:!0,opacity:.035*c,blending:Ge,depthWrite:!1}))),dn.add(r),Lc.push(r)}function c0(){let i=new Xe({color:12179668,transparent:!0,opacity:.085});for(let e=0;e<=8;e++){let n=Wn+fn*.5-e*fn,s=new ee().setFromPoints([new L(-8.2,n,-.7),new L(8.2,n,-.7)]);dn.add(new ei(s,i))}yt.strips.forEach((e,n)=>{let s=Wn-n*fn;yt.themes.forEach((r,a)=>{let o=[];for(let h=0;h<30;h++){let u=h/29,d=ds+u*(Ze-1.32-ds),p=(a/11-.5)*.56,g=s+p*(1-u*.72)+Math.sin(u*Math.PI*3+a*1.91+n)*.016;o.push(new L(d,g,-.38+Math.sin(a*2.3)*.07))}let c=new Ds(o),l=new ee().setFromPoints(c.getPoints(60));dn.add(new ei(l,new Xe({color:r.color,transparent:!0,opacity:.021,blending:Ye,depthWrite:!1})))})});let t=new ee().setFromPoints([new L(Ze-1.48,-4.2,-.3),new L(Ze-1.48,4.2,-.3)]);dn.add(new ei(t,new Us({color:11131346,transparent:!0,opacity:.1,dashSize:.04,gapSize:.05})))}function Me(i){let t=2166136261;for(let e=0;e<i.length;e++)t=Math.imul(t^i.charCodeAt(e),16777619);return(t>>>0)/4294967295}function nu(i){return{gradient:.2,fungal:.3,elegans:.34,drosophila:.34,rodent:.36,macaque:.36,human:.4,ai:.4}[i]??.3}function l0(){let i=yt.timeline.map(n=>Math.pow(Math.max(1,n.query_count),.19)),t=i.reduce((n,s)=>n+s,0);Se=[0];let e=0;i.forEach(n=>{e+=n/t,Se.push(e)}),Se[Se.length-1]=1,yt.papers.forEach(n=>{let s=Qs.get(n.year)??[];s.push(n),Qs.set(n.year,s)})}function Uc(i,t=1){let e=Math.max(0,Math.min(yt.timeline.length-1,i-1976));return Se[e]+(Se[e+1]-Se[e])*((t-1)/12)}function h0(i){let t=0;for(;t<Se.length-2&&i>=Se[t+1];)t++;let e=(i-Se[t])/Math.max(1e-7,Se[t+1]-Se[t]);return{year:1976+t,fraction:e,frame:yt.timeline[t],index:t}}function iu(i){let t=ut("#publication-axis"),e=t.getBoundingClientRect();if(!e.width||!e.height)return;let n=Math.min(devicePixelRatio,2.5);t.width=Math.round(e.width*n),t.height=Math.round(e.height*n);let s=t.getContext("2d");if(!s)return;s.scale(n,n);let r=e.width,a=e.height,o=yt.timeline.map(u=>Math.log10(Math.max(u.query_count,1))),c=Math.min(...o),l=Math.max(...o);s.clearRect(0,0,r,a),yt.timeline.forEach((u,d)=>{let p=Se[d]*r,g=Math.max(1,(Se[d+1]-Se[d])*r-1),m=3+(o[d]-c)/Math.max(l-c,1e-6)*(a-4),f=new Map;(Qs.get(u.year)??[]).forEach(M=>f.set(M.theme,(f.get(M.theme)??0)+1));let E=[...f].sort((M,I)=>I[1]-M[1])[0]?.[0],S=yt.themes.find(M=>M.id===E)?.color??"#78ead8";s.globalAlpha=d===i?1:d<i?.42:.15,s.fillStyle=S,s.fillRect(p,a-m,g,m)}),s.globalAlpha=.55,s.fillStyle="#dffcf6";let h=Se[Math.min(i,Se.length-2)]*r;s.fillRect(h,0,1,a),s.globalAlpha=1}function u0(i){let t=[],e=[],n=[],s=[],r=[],a=[],o=[],c=[],l=new Ot;yt.papers.forEach(p=>{let g=Object.entries(p.strips).sort((m,f)=>f[1]-m[1]),_=g[0]?.[0];g.forEach(([m,f])=>{if(f<nu(m)&&m!==_)return;let E=yt.strips.findIndex(V=>V.id===m),S=i[m];if(E<0||!S?.length)return;let M=yt.themes.findIndex(V=>V.id===p.theme),I=Me(`${p.pmid}:${m}`),A=Math.floor((M+I*.9)/yt.themes.length%1*S.length),R=S[A],N=Uc(p.year,p.month),b=ds+N*($h-ds),y=Wn-E*fn,P=y+(M/11-.5)*.54+p.xyz[1]*.035;t.push(b,P,p.xyz[2]*.12),e.push(R.x,R.y,R.z+.04),l.set(yt.themes[Math.max(0,M)]?.color??"#ffffff"),n.push(l.r,l.g,l.b),s.push(N),r.push(f),a.push(1.2+p.density*1.9+f*1.4),o.push(y),c.push(Dc(m))})});let h=new ee;h.setAttribute("position",new zt(e,3)),h.setAttribute("aStream",new zt(t,3)),h.setAttribute("aTarget",new zt(e,3)),h.setAttribute("aColor",new zt(n,3)),h.setAttribute("aBirth",new zt(s,1)),h.setAttribute("aStrength",new zt(r,1)),h.setAttribute("aSize",new zt(a,1)),h.setAttribute("aLaneY",new zt(o,1)),h.setAttribute("aSpinRate",new zt(c,1));let u=new be({vertexShader:Jg,fragmentShader:jh,uniforms:Je,transparent:!0,blending:Ye,depthWrite:!1});dn.add(new Oe(h,u));let d=new ee;d.setAttribute("position",new zt(t,3)),d.setAttribute("aColor",new zt(n,3)),d.setAttribute("aBirth",new zt(s,1)),d.setAttribute("aStrength",new zt(r,1)),d.setAttribute("aSize",new zt(a,1)),dn.add(new Oe(d,new be({vertexShader:Qh,fragmentShader:tu,uniforms:Je,transparent:!0,blending:Ye,depthWrite:!1})))}function d0(){De.traverse(i=>{let t=i;t.geometry&&t.geometry.dispose();let e=t.material;Array.isArray(e)?e.forEach(n=>n.dispose()):e?.dispose()}),De.clear(),ja=[],Js.clear(),Ks=void 0,eo=[],no=[],js=void 0,Ci()}function su(i){return yt.papers.filter(t=>{let e=Object.entries(t.strips).sort((n,s)=>s[1]-n[1]);return(t.strips[i]??0)>=nu(i)||e[0]?.[0]===i})}function f0(i){d0();let t=yt.strips[i],e=Ic[t.id];if(!e?.points.length)return;let n=new Float32Array(e.points.length*3);e.points.forEach((E,S)=>E.toArray(n,S*3));let s=new ee;s.setAttribute("position",new ae(n,3));let r=r0(e,t.id);s.setAttribute("aGraphPhase",new ae(r.phase,1)),s.setAttribute("aDegree",new ae(r.degree,1)),s.setAttribute("aNodeSeed",new ae(r.seed,1)),De.add(new Oe(s,new be({vertexShader:jg,fragmentShader:Qg,uniforms:{...Je,uColor:{value:new Ot(t.color)}},transparent:!0,blending:Ye,depthWrite:!1})));let a=new Float32Array(e.edges.length*6);e.edges.forEach(([E,S],M)=>{e.points[E]?.toArray(a,M*6),e.points[S]?.toArray(a,M*6+3)});let o=new ee;o.setAttribute("position",new ae(a,3)),js=new Xe({color:t.color,transparent:!0,opacity:.13,blending:Ye,depthWrite:!1}),De.add(new On(o,js));let c=[...e.points].sort((E,S)=>Math.atan2(E.y,E.x)+E.z*.2-(Math.atan2(S.y,S.x)+S.z*.2)),l=su(t.id),h=[],u=[],d=[],p=[],g=[],_=new Map,m=new Ot;l.forEach(E=>{let S=Math.max(0,yt.themes.findIndex(b=>b.id===E.theme)),M=Me(`${E.pmid}:${t.id}`),I=Math.floor((S+M*.9)/yt.themes.length%1*c.length),A=c[I];A.toArray(h,h.length);let R=new L(E.xyz[0]+(M-.5)*.3,E.xyz[1]+(Me(`${E.pmid}:orbit`)-.5)*.3,E.xyz[2]+(Me(`${E.pmid}:depth`)-.5)*.3);R.lengthSq()<.01&&R.set(1,0,0),R.normalize().multiplyScalar(3.25+Me(`${E.pmid}:radius`)*1.75),R.toArray(u,u.length),m.set(yt.themes[S]?.color??"#ffffff"),d.push(m.r,m.g,m.b),p.push(Uc(E.year,E.month)),g.push(E.strips[t.id]??.18);let N=E.form_clusters?.[t.id];if(N!=null&&N>=0){let b=_.get(N)??[];b.push(A),_.set(N,b)}}),Js.clear();let f=new ee;f.setAttribute("position",new zt(h,3)),f.setAttribute("aOrigin",new zt(u,3)),f.setAttribute("aColor",new zt(d,3)),f.setAttribute("aBirth",new zt(p,1)),f.setAttribute("aStrength",new zt(g,1)),Ks=new Oe(f,new be({vertexShader:Kg,fragmentShader:jh,uniforms:Je,transparent:!0,blending:Ye,depthWrite:!1})),eo=l,no=p,De.add(Ks),_.forEach((E,S)=>{if(E.length<5)return;let M=yt.form_clusters?.[t.id]?.find(b=>b.id===S);if(!M)return;Js.add(S);let I=[...E].sort((b,y)=>b.x*.71+b.y*.23+b.z*.49-(y.x*.71+y.y*.23+y.z*.49)).filter((b,y)=>y%Math.max(1,Math.floor(E.length/92))===0).slice(0,96),A=[];I.forEach((b,y)=>{y&&(b.toArray(A,A.length),I[y-1].toArray(A,A.length)),y>5&&y%4===0&&(b.toArray(A,A.length),I[y-5].toArray(A,A.length))});let R=new ee;R.setAttribute("position",new zt(A,3));let N=new On(R,new Xe({color:M.color,transparent:!0,opacity:0,blending:Ye,depthWrite:!1}));N.userData.clusterId=S,N.userData.emergence=M.emergence_year,De.add(N),ja.push(N)}),De.rotation.set(.06,-.18,0)}function ru(i){if(!Ka||i<0||i>=yt.strips.length)return;Ke=i,$s=Pi=4.2,oi.position.set(0,0,$s),f0(i);let t=yt.strips[i],e=Za.entries.find(n=>n.id===t.id);ut("#focus-index").textContent=`0${i+1} / 08`,ut("#focus-title").textContent=t.name.toUpperCase(),ut("#focus-cluster-scope").textContent=t.name.toUpperCase(),ut("#focus-source").textContent=`${e?.kind?.replaceAll("-"," ").toUpperCase()??"GENERATIVE FORM"} / ${t.source_short.toUpperCase()}`,ut("#focus-description").textContent=`${su(t.id).length.toLocaleString()} publications inhabit this three-dimensional semantic body. Drag to orbit; travel through the surface to inspect its interior. Placement is semantic, not anatomical localization.`,ut("#focus-panel").setAttribute("aria-hidden","false"),document.body.classList.add("focus-active"),us=-1}function au(){Ke=-1,tr=!1,rn.clear(),ut("#focus-panel").setAttribute("aria-hidden","true"),document.body.classList.remove("focus-active","dragging"),Ci()}function p0(){Pi=4.2,De.rotation.set(.06,-.18,0)}function m0(i,t,e){return i==="ai"?t<1986?"CYBERNETIC & PERCEPTRON FOUNDATIONS":t<2006?"CONNECTIONISM & BACKPROPAGATION":t<2012?"STATISTICAL LEARNING FOR NEURAL DATA":"DEEP REPRESENTATION LEARNING":`${yt.strips.find(s=>s.id===i)?.name.toUpperCase()??i.toUpperCase()} \xB7 ${e}`}function g0(i,t,e){if(Ke<0)return;$s+=(Pi-$s)*Math.min(1,e*8),oi.position.z=$s,tr||(De.rotation.y+=e*.115),De.position.y=0;let n=0;for(let l of no)n+=Math.exp(-Math.abs(pe-(l+.036))*170);let s=pe>=.99995?0:ai.clamp(Math.sqrt(n)*.035,0,.22),r=s>Je.uFire.value?18:14;Je.uFire.value+=(s-Je.uFire.value)*Math.min(1,e*r),js&&(js.opacity=.13+Je.uFire.value*.008),ja.forEach(l=>{let h=yt.strips[Ke].id,u=yt.form_clusters?.[h]?.find(g=>g.id===l.userData.clusterId),d=l.material,p=u&&u.emergence_year<=i.year;l.visible=!!p,d.opacity=p?.035+Math.sin(t*1.3+l.userData.clusterId)*.018:0});let a=yt.strips[Ke].id,o=(yt.form_clusters?.[a]??[]).filter(l=>l.emergence_year<=i.year&&Js.has(l.id));if(!o.length){let l=eo.filter(h=>h.year<=i.year);if(l.length>=3){let h=new Map;l.forEach(g=>h.set(g.theme,(h.get(g.theme)??0)+1));let u=[...h].sort((g,_)=>_[1]-g[1])[0]?.[0],d=yt.themes.find(g=>g.id===u)?.name.toUpperCase()??"EARLY LITERATURE",p=(yt.form_clusters?.[a]??[]).filter(g=>Js.has(g.id)).sort((g,_)=>g.emergence_year-_.emergence_year)[0];ut("#focus-cluster-count").textContent="00",ut("#focus-cluster-name").textContent=m0(a,i.year,d),ut("#focus-cluster-terms").textContent=`${l.length.toLocaleString()} ENTITY-SPECIFIC PAPERS FORM A REPEATABLE HISTORICAL SIGNAL, BEFORE DENSITY-STABLE MANIFOLD SEPARATION.`,ut("#focus-coherence").style.width="0%",ut("#focus-cluster-meta").textContent=p?`PIONEERING EVIDENCE / FIRST STABLE FORMATION ${p.emergence_year}`:"PIONEERING EVIDENCE / DENSITY FORMATION ACCUMULATING";return}ut("#focus-cluster-count").textContent="00",ut("#focus-cluster-name").textContent="EVIDENCE FIELD OPENING",ut("#focus-cluster-terms").textContent="FEWER THAN THREE ENTITY-SPECIFIC PAPERS ARE PRESENT AT THIS DATE.",ut("#focus-coherence").style.width="0%",ut("#focus-cluster-meta").textContent=`${a.toUpperCase()}-SPECIFIC / REPEATABILITY THRESHOLD PENDING`;return}let c=o[Math.floor(pe*Math.max(1,o.length*7))%o.length];ut("#focus-cluster-count").textContent=String(o.length).padStart(2,"0"),ut("#focus-cluster-name").textContent=c.label.toUpperCase(),ut("#focus-cluster-terms").textContent=c.vocabulary.join(" \xB7 ").toUpperCase()||c.theme.toUpperCase(),ut("#focus-coherence").style.width=`${Math.round(c.coherence*100)}%`,ut("#focus-coherence").style.background=c.color,ut("#focus-cluster-meta").textContent=`${a.toUpperCase()}-SPECIFIC \xB7 EMERGENCE ${c.emergence_year} / ${c.size.toLocaleString()} PAPERS / COHERENCE ${c.coherence.toFixed(2)}`,ja.forEach(l=>{let h=l.material;l.userData.clusterId===c.id&&(h.opacity=.17+Math.sin(t*2.1)*.04)})}function _0(){let t=new Float32Array(2850);for(let n=0;n<950;n++)t[n*3]=(Math.random()-.5)*17,t[n*3+1]=(Math.random()-.5)*9.2,t[n*3+2]=-1-Math.random()*2;let e=new ee;e.setAttribute("position",new ae(t,3)),dn.add(new Oe(e,new vn({color:9358276,size:.75,sizeAttenuation:!1,opacity:.08,transparent:!0,depthWrite:!1})))}function x0(){let i=[],t=[],e=[],n=[],s=[],r=yt.timeline.map(h=>Math.log10(Math.max(1,h.query_count))),a=Math.min(...r),o=Math.max(...r),c=new Ot;yt.timeline.forEach((h,u)=>{let d=Qs.get(h.year)??[],p=(r[u]-a)/Math.max(.001,o-a),g=Math.round(54+p*236);for(let _=0;_<g;_++){let m=d.length?d[Math.floor(Me(`${h.year}:${_}:sample`)*d.length)]:yt.papers[Math.floor(Me(`${h.year}:${_}:fallback`)*yt.papers.length)],f=Object.entries(m?.strips??{}).sort((b,y)=>y[1]-b[1]),E=f[Math.min(f.length-1,Math.floor(Me(`${h.year}:${_}:lane`)*Math.min(3,f.length)))]?.[0],S=Math.max(0,yt.strips.findIndex(b=>b.id===E)),M=Math.max(0,yt.themes.findIndex(b=>b.id===m?.theme)),I=1+Math.floor(Me(`${h.year}:${_}:month`)*12),A=Uc(h.year,I),R=ds+A*($h-ds),N=Wn-S*fn+(M/Math.max(1,yt.themes.length-1)-.5)*.48+(Me(`${h.year}:${_}:jitter`)-.5)*.075;i.push(R,N,-.52+(Me(`${h.year}:${_}:z`)-.5)*.22),c.set(yt.themes[M]?.color??"#78ead8"),t.push(c.r,c.g,c.b),e.push(A),n.push(.14+p*.38),s.push(.32+p*.75)}});let l=new ee;l.setAttribute("position",new zt(i,3)),l.setAttribute("aColor",new zt(t,3)),l.setAttribute("aBirth",new zt(e,1)),l.setAttribute("aStrength",new zt(n,1)),l.setAttribute("aSize",new zt(s,1)),dn.add(new Oe(l,new be({vertexShader:Qh,fragmentShader:tu,uniforms:Je,transparent:!0,blending:Ye,depthWrite:!1})))}function v0(){let i=ut("#strip-labels");i.innerHTML=yt.strips.map((n,s)=>`<button type="button" class="strip-label" data-index="0${s+1}" data-lane="${s}" data-strip="${n.id}" aria-label="Explore ${n.name} in 3D"><b>${n.name}</b><span>${n.source_short}</span></button>`).join(""),i.querySelectorAll(".strip-label").forEach(n=>{n.addEventListener("click",()=>ru(Number(n.dataset.lane)))});let t=ut("#topic-key");t.innerHTML=yt.themes.map(n=>`<span class="topic-chip" data-theme="${n.id}" style="--c:${n.color}">${n.name.toUpperCase()}</span>`).join("");let e=yt.timeline.reduce((n,s)=>n+s.query_count,0);ut("#corpus-count").textContent=`${(e/1e6).toFixed(2)}M QUERY UNIVERSE \xB7 ${yt.papers.length.toLocaleString()} EMBEDDED`}function y0(i,t){let e=Math.min(2026,i.year+Math.floor(i.fraction));ut("#year").textContent=String(e),ut("#publication-count").textContent=`${i.frame.query_count.toLocaleString()} MATCHING RECORDS / YEAR`,ut("#timeline").style.setProperty("--progress",`${pe*100}%`),ut("#timeline").value=String(pe),ge.update(i.frame,pe),ut("#chord").textContent=ge.label();let n=document.querySelector('.strip-label[data-strip="ai"] span');n&&Be&&(n.textContent=Be.stageName);let s=Qs.get(i.year)??[],r=new Map;s.forEach(m=>r.set(m.theme,(r.get(m.theme)??0)+1));let a=[...r].sort((m,f)=>f[1]-m[1])[0]?.[0]??yt.themes[0].id,o=yt.themes.find(m=>m.id===a)??yt.themes[0];ut("#topic").textContent=o.name.toUpperCase();let c=Math.max(1,...r.values());document.querySelectorAll(".topic-chip").forEach(m=>{let f=r.get(m.dataset.theme??"")??0;m.classList.toggle("active",m.dataset.theme===a),m.style.setProperty("--weight",String(.18+f)),m.style.setProperty("--dominance",String(.18+.82*f/c))}),Cc!==i.index&&(Cc=i.index,iu(i.index));let l=i.frame,h=(yt.clusters??[]).filter(m=>m.emergence_year<=i.year),u=l.new_clusters?.[0],d=Math.floor(pe*Math.max(1,h.length*3)),p=(u!=null?yt.clusters?.find(m=>m.id===u):void 0)??h[d%Math.max(1,h.length)];if(pe>=1){if(ut("#formation-name").textContent="ALL DETECTED FORMATIONS IN CONVERGENCE",ut("#formation-meta").textContent=`2026 / ${h.length} ACTIVE FORMATIONS / FINAL HARMONIC FIELD`,us!==-2){us=-2;let m=ut("#formation-ticker");m.classList.remove("flare"),m.offsetWidth,m.classList.add("flare")}}else if(p){if(ut("#formation-name").textContent=p.label.toUpperCase(),ut("#formation-meta").textContent=`${p.emergence_year} / ${p.theme.toUpperCase()} / ${p.size.toLocaleString()} PAPERS`,p.id!==us){us=p.id;let m=ut("#formation-ticker");m.classList.remove("flare"),m.offsetWidth,m.classList.add("flare")}}else ut("#formation-name").textContent="PRE-FORMATION FIELD",ut("#formation-meta").textContent=`${i.year} / DENSITY THRESHOLDS ACCUMULATING`;let g=[...qh].reverse().find(m=>m.year<=i.year)??qh[0];ut("#landmark").textContent=`${g.year} / ${g.label}`;let _=Math.floor(t/1.7);if(_!==Ii&&s.length){Ii=_;let m=s.filter(S=>i.fraction>(S.month-1)/12),f=(m.length?m:s)[_%(m.length||s.length)],E=yt.themes.find(S=>S.id===f.theme);ut("#paper-year").textContent=`${f.year} \xB7 PMID ${f.pmid}`,ut("#paper-theme").textContent=E?.name.toUpperCase()??f.theme.toUpperCase(),ut("#paper-theme").style.color=E?.color??"#78ead8",ut("#paper-title").textContent=f.title,ut("#paper-journal").textContent=`${f.journal||"PUBMED"} \xB7 ${Object.keys(f.strips).slice(0,3).join(" / ").toUpperCase()}`}}async function M0(){globalThis.__NEURO_CORPUS__&&globalThis.__NEURO_ATLAS__?(yt=globalThis.__NEURO_CORPUS__,Za=globalThis.__NEURO_ATLAS__):[yt,Za]=await Promise.all([fetch("./public/data/corpus.json").then(t=>t.json()),fetch("./public/data/templates.json").then(t=>t.json())]),l0(),v0(),_0(),c0(),x0(),yt.strips.forEach((t,e)=>{let n=Wn-e*fn;if(t.id==="ai")return;let s=Za.entries.find(o=>o.id===t.id),r;t.id==="gradient"?r=n0():t.id==="fungal"?r=i0():r={points:t0(s),edges:e0(s)},Ic[t.id]=Yh(r,t.id);let a=s0(r,t.id,n);o0(a,t.color,t.id),Ac[t.id]=[...a.points].sort((o,c)=>Math.atan2(o.y-n,o.x-Ze)+o.z*.2-(Math.atan2(c.y-n,c.x-Ze)+c.z*.2))}),Be=new $a(Ze,Wn-7*fn),Be.group.userData.spinRate=Dc("ai"),dn.add(Be.group),Lc.push(Be.group),Be.update(2026,0),Ac.ai=Be.destinations.map(t=>t.clone()).sort((t,e)=>Math.atan2(t.y-Be.group.position.y,t.x-Ze)-Math.atan2(e.y-Be.group.position.y,e.x-Ze));let i=Be.focusPoints.map(t=>t.clone());Ic.ai=Yh({points:i,edges:Be.focusEdges},"ai"),Be.update(1976,0),u0(Ac),ut("#loading").classList.add("done"),requestAnimationFrame(cu)}function ou(){$e.setPixelRatio(Math.min(window.devicePixelRatio,2.5)),$e.setSize(innerWidth,innerHeight,!1);let i=9.2,t=i*(innerWidth/innerHeight);kn.left=-t/2,kn.right=t/2,kn.top=i/2,kn.bottom=-i/2,kn.updateProjectionMatrix(),oi.aspect=innerWidth/innerHeight,oi.updateProjectionMatrix(),Je.uPixelRatio.value=$e.getPixelRatio(),yt&&iu(Math.max(0,Cc))}function cu(){let i=Math.min(.05,Zg.getDelta());Ka&&Vn&&(Tc+=i*hs,wc+=i,pe<1?(pe=Math.min(1,pe+i/(178/hs)),Gn=0):(Gn+=i,Gn>=Zh&&(pe=0,Gn=0,Tc=0,Ii=-1,us=-1,ge.seek())));let t=Tc;if(Je.uTime.value=pe,Je.uPulse.value=t,Je.uSpatialTime.value=wc,Lc.forEach(e=>{e.rotation.x=Jh,e.rotation.y=Math.sin(wc*Number(e.userData.spinRate??.1))*Kh}),yt){let e=h0(pe);Be?.update(e.year+e.fraction,t),y0(e,t),g0(e,t,i),ge.tick(),Ka&&!ge.isMuted()&&!ge.isRunning()&&Qa("retry")}kn.position.x=Math.sin(t*.067)*.025,kn.position.y=Math.cos(t*.053)*.018,$e.render(dn,kn),Ke>=0&&($e.autoClear=!1,$e.clearDepth(),$e.render(to,oi),$e.autoClear=!0),requestAnimationFrame(cu)}var Ja=ut("#sound");function Qa(i){Ja.textContent=i==="on"?"SOUND ON":i==="off"?"SOUND OFF":"AUDIO RETRY",Ja.setAttribute("aria-label",i==="retry"?"Retry audio":"Mute or unmute"),Ja.setAttribute("title",i==="on"?"Audio running":i==="off"?"Audio muted":"Click to retry browser audio")}async function Nc(){try{if(!await ge.start())throw new Error("The browser did not start its audio context");return ge.setMuted(!1),ge.setPaused(!Vn),Qa("on"),!0}catch(i){return console.error("Audio could not start",i),Qa("retry"),!1}}ut("#enter").addEventListener("click",()=>{Ka=!0,Vn=!0,ut("#entry").classList.add("hidden"),Nc()});function lu(i){i&&pe>=1&&Gn>=Zh&&(pe=0,Gn=0,Ii=-1,ge.seek()),Vn=i,ut("#play").textContent=Vn?"PAUSE":"PLAY",Vn&&!ge.isMuted()&&!ge.isRunning()?Nc():ge.setPaused(!Vn)}ut("#play").addEventListener("click",()=>lu(!Vn));ut("#timeline").addEventListener("input",i=>{pe=Number(i.target.value),Gn=0,Ii=-1,ge.seek()});var Rc=[.5,1,2,4,8];ut("#speed").addEventListener("click",()=>{hs=Rc[(Rc.indexOf(hs)+1)%Rc.length],ut("#speed").textContent=`${hs}\xD7`,ge.setPlaybackSpeed(hs)});async function hu(){if(ge.isMuted()||!ge.isRunning()){await Nc();return}ge.setMuted(!0),Qa("off")}Ja.addEventListener("click",()=>{hu()});async function uu(){document.fullscreenElement?await document.exitFullscreen():await document.documentElement.requestFullscreen()}ut("#full").addEventListener("click",uu);ut("#focus-close").addEventListener("click",au);function Ci(){let i=document.querySelector("#node-tooltip");i&&(i.classList.remove("visible"),i.setAttribute("aria-hidden","true"))}function b0(i){if(Ke<0||tr||!Ks){Ci();return}let t=pn.getBoundingClientRect();Xh.set((i.clientX-t.left)/t.width*2-1,-((i.clientY-t.top)/t.height)*2+1),De.updateMatrixWorld(!0),oi.updateMatrixWorld(!0),Pc.setFromCamera(Xh,oi);let n=Pc.intersectObject(Ks,!1)[0]?.index;if(n==null||no[n]>pe+.002){Ci();return}let s=eo[n];if(!s){Ci();return}let r=yt.themes.find(p=>p.id===s.theme),a=yt.strips[Ke].id,o=s.form_clusters?.[a],c=o!=null?yt.form_clusters?.[a]?.find(p=>p.id===o):void 0,l=ut("#node-tooltip");ut("#node-tooltip-meta").textContent=`${s.year} \xB7 PMID ${s.pmid} \xB7 ${r?.name.toUpperCase()??s.theme.toUpperCase()}`,ut("#node-tooltip-meta").style.color=r?.color??"#78ead8",ut("#node-tooltip-title").textContent=s.title,ut("#node-tooltip-cluster").textContent=c?`${a.toUpperCase()}-SPECIFIC \xB7 ${c.label.toUpperCase()} \xB7 COHERENCE ${c.coherence.toFixed(2)} \xB7 ${s.journal||"PUBMED"}`:`NO STABLE ${a.toUpperCase()}-SPECIFIC FORMATION \xB7 ${s.journal||"PUBMED"}`;let h=Math.min(innerWidth*.2,380),u=Math.min(i.clientX+18,innerWidth-h-18),d=Math.min(i.clientY+18,innerHeight-126);l.style.left=`${Math.max(12,u)}px`,l.style.top=`${Math.max(12,d)}px`,l.classList.add("visible"),l.setAttribute("aria-hidden","false")}function S0(i){let t=pn.getBoundingClientRect(),e=(i.clientX-t.left)/t.width*2-1,n=1-(i.clientY-t.top)/t.height*2,s=9.2,r=s*(t.width/t.height),a=e*r*.5,o=n*s*.5;if(a<Ze-1.65||a>Ze+1.65)return-1;let c=Math.round((Wn-o)/fn);return c>=0&&c<8&&Math.abs(o-(Wn-c*fn))<fn*.48?c:-1}pn.addEventListener("pointerdown",i=>{if(Ke<0){let t=S0(i);t>=0&&ru(t);return}if(pn.setPointerCapture(i.pointerId),rn.set(i.pointerId,{x:i.clientX,y:i.clientY}),tr=!0,document.body.classList.add("dragging"),Ci(),rn.size===2){let t=[...rn.values()];Zs=Math.hypot(t[0].x-t[1].x,t[0].y-t[1].y)}});pn.addEventListener("pointermove",i=>{if(Ke<0)return;if(!rn.has(i.pointerId)){b0(i);return}let t=rn.get(i.pointerId);if(rn.set(i.pointerId,{x:i.clientX,y:i.clientY}),rn.size>=2){let e=[...rn.values()],n=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y);Zs>0&&(Pi=ai.clamp(Pi*(Zs/Math.max(n,1)),.42,7.5)),Zs=n}else De.rotation.y+=(i.clientX-t.x)*.0062,De.rotation.x=ai.clamp(De.rotation.x+(i.clientY-t.y)*.0052,-1.45,1.45)});function du(i){rn.delete(i.pointerId),rn.size<2&&(Zs=0),rn.size||(tr=!1,document.body.classList.remove("dragging"))}pn.addEventListener("pointerup",du);pn.addEventListener("pointercancel",du);pn.addEventListener("pointerleave",Ci);pn.addEventListener("wheel",i=>{Ke<0||(i.preventDefault(),Pi=ai.clamp(Pi*Math.exp(i.deltaY*.00105),.42,7.5))},{passive:!1});pn.addEventListener("dblclick",()=>{Ke>=0&&p0()});window.addEventListener("resize",ou);window.addEventListener("keydown",i=>{i.code==="Space"&&(i.preventDefault(),lu(!Vn)),i.key.toLowerCase()==="m"&&hu(),i.key.toLowerCase()==="h"&&(Ec=!Ec,document.body.classList.toggle("capture-clean",Ec)),i.key.toLowerCase()==="f"&&uu(),(i.key==="ArrowRight"||i.key==="ArrowLeft")&&(pe=ai.clamp(pe+(i.key==="ArrowRight"?.01:-.01),0,1),Gn=0,Ii=-1,ge.seek()),i.key.toLowerCase()==="r"&&(pe=0,Gn=0,Ii=-1,ge.seek()),i.key==="Escape"&&Ke>=0&&au()});ou();M0().catch(i=>{console.error(i),ut("#loading").innerHTML=`<em>THE FIELD COULD NOT ASSEMBLE \xB7 ${String(i)}</em>`});})();
