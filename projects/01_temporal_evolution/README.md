...
| Rodent | American Beaver (*Castor canadensis*) #63-168 whole-brain photographs and serial coronal histology | Source-derived |
...
The compact browser geometry contains up to 5,000 source-derived points for each biological reference, plus sparse morphology or surface edges. The RODENT lane uses the lateral and dorsal whole-brain photographs plus a stain-aware reconstruction of the [American Beaver #63-168 picture atlas](https://brains.anatomy.msu.edu/museum/brain/specimens/rodentia/beaver/sections/thumbnail.html). The exposed spinal cord is excluded. The photographs calibrate the AP span, one shared in-plane scale, and the center curves of the serial reconstruction. Every retained point is an actual boundary pixel from a coronal beaver section, and no section is fitted to a synthetic ellipse. Plates spanning the cerebellum receive denser sampling so their folia remain legible at browser scale. Of 123 indexed plates, 108 encephalic plates through #2180 are used for the scaffold. The high-resolution #1780 plate is unavailable at the source. The final geometry uses one uniform scale, with no independent-axis stretching. Source images are checksummed during derivation and are not redistributed. Credit belongs to the Comparative Mammalian Brain Collections and the National Science Foundation; the collection's [image-use notice](https://brains.anatomy.msu.edu/copyright.html) remains authoritative.
