...
STRIPS = [
    ...
    },
    {
        ...
        "color": "#5EC8FF",
        "anchor": "Artificial intelligence in dialogue with neuroscience: learned artificial neural networks, deep learning models of brain and cognition, representation learning, transformers, recurrent networks, reinforcement learning, neuromorphic systems, brain decoding and comparisons of artificial and biological intelligence.",
        "positive": [
            r"artificial neural network", r"deep neural network", r"\bneuroai\b",
            r"neuromorphic", r"biologically inspired (?:learning|network|ai)",
            r"brain decoding", r"transformer.*(?:brain|neural|cognit)",
            r"(?:brain|neural|cognit).*transformer", r"representational similarity.*network",
        ],
        "negative": [r"routine segmentation", r"diagnostic classifier"],
    },
]
